...
-->
	...
	<table align="center">
	<s:iterator value="fwxx2" var="fwxx2">
	<tr>
	...
	<tr>
		<td width='100'><a href="post.htm">修改租房信息</a></td>
	</tr>
	<tr>
	...
	<form action="fwxx_toupdateview" method="post" name="mf" onsubmit="return validateTitle()">
		...
		<table>
			...
			<tr>
			  <td><strong>标题：</strong></td>
				<td><input type="text" name="title" value="${fwxx2.title}"></td>
				<input type="hidden" name="fwid" value="${fwxx2.fwid}">
			</tr>
			<tr>
...
<option value='18'>平谷</option>
			...
			<tr>
				...
				<td><select name="jdid">
					<option value="${fwxx2.jdid}">${jd.jd}</option>
					<option value="0">不限--</option>
				</select>
				</td>
			</tr>
			<tr>
			  <td><strong>租金：</strong></td>
				<td><input type="text" name="zj" value="${fwxx2.zj}"/>元/月</td>
			</tr>
			<tr>
			  <td><strong>户型：</strong></td>
				<td>
				<s:select name="shi" id="shi" list="{'1','2','3','4','5','6'}" value="%{fwxx2.shi}"></s:select>室
				<s:select name="ting" id="ting" list="{'1','2','3','4','5','6'}" value="%{fwxx2.ting}"></s:select>厅
				</td>
			</tr>
			<tr>
			  <td><strong>房屋类型：</strong></td>
				<td>
				<s:select name="lxid" id="lxid" list="#{1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}" value="%{fwxx2.lxid}"></s:select>
				</td>
			</tr>
			<tr>
			  <td><strong>联系电话：</strong></td>
				<td><input type="text" name="telephone" value="${fwxx2.telephone}"></td>
			</tr>
			<tr>
			  <td><strong>联系人：</strong></td>
				<td><input type="text" name="lxr" value="${fwxx2.lxr}"></td>
			</tr>
			<tr>
			<td>发布时间:</td>
			<td><input type="text" name="publishdate" value="${fwxx2.publishdate}"></td>
			</tr>
			<tr>
			  <td><strong>房屋信息：</strong></td>
				<td><textarea name="fwxxx" rows="10" cols="40">${fwxx2.fwxx}</textarea></td>
			</tr>
			<tr>
				<td colspan="2">
