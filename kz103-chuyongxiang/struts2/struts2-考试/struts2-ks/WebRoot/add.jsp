...
-->
	...
	<form action="fwxx_toadd" method="post" name="mf" onsubmit="return validateTitle()">
...
<option value='18'>平谷</option>
			...
			<tr>
			  <td><strong>户型：</strong></td>
				<td>
				<s:select name="shi" id="shi" list="{'1','2','3','4','5','6'}"></s:select>室
				<s:select name="ting" id="ting" list="{'1','2','3','4','5','6'}"></s:select>厅
				</td>
			</tr>
			<tr>
			  <td><strong>房屋类型：</strong></td>
				<td>
				<s:select name="lxid" id="lxid" list="#{1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}"></s:select>
				</td>
			</tr>
			<tr>
			...
			<tr>
			  <td><strong>房屋信息：</strong></td>
				<td><textarea name="fwxxx" rows="10" cols="40"></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
