...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table align="center">
		<tr>
		  <td><a href="fwxx_selectpage2">返回首页</a></td>
		</tr>
		<tr>
    ...
    <td width="495">
	<form action="user_zhuce" method="post" name="myForm" onsubmit="return pass()">
		<table align="center">
			<tr>
				<td>用户注册：</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td>用户名：</td>
				<td><input type="text" name="uname"><s:fielderror fieldName="uname"></s:fielderror></td>
			<tr>
				<td>密码：</td>
