...
border-width:0 0 1px 0;
	...
	<form action="fwxx_superselect" method="post" name="mf">
...
<tr>
			...
			<tr>
				<td>房屋类型：</td>
				<td>
				<s:checkboxlist list="#{1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}"  name="lxid"></s:checkboxlist>
			</td>
			</tr>
			<tr>
				<td>发布日期：</td>
				<td><select name="fabudate" style="width:80">
					<option value="0">不限--</option>
...
<table width="88%" cellspacing="0">
				...
				<tr>
				<td><fyy:fy pageIndex="${pageIndex}" pageSize="${pageYS}" pageUrl="fwxx_selectpage3"></fyy:fy></td>
				</tr>
			</table>
	</form>
	</td>
