...
prompt Created on 2017年11月29日 by Captain
set feedback off
set define off
...
values (1, 0, 1, 1, 1, 1, '超级啊啊啊啊啊是的123', 1222, '好房', to_date('14-11-2017', 'dd-mm-yyyy'), '15515151', '王师傅');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (2, 0, 145, 4, 2, 2, '大大大大大大房是', 2121, '超级', to_date('27-11-2017', 'dd-mm-yyyy'), '5151', '升水');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (61, 0, 40, 5, 2, 1, '434', 232, '哈哈哈哈', to_date('01-11-2017', 'dd-mm-yyyy'), '343', '43');
commit;
