			...
			<tr>
				...
				<td width="172">
					<table align="center">
						<tr>
							<td>
								<a href="${basePath}page/index.jsp">返回首页</a>
							</td>
						</tr>
						<tr>
							<td>
								<a href="${basePath}page/login_form.jsp">用户登陆</a>
							</td>
						</tr>
					</table>
				</td>
				...
				<td width="495">
					<form action="user_zhuce" method="post" name="myForm"
						...
						<table align="center">
							...
							<tr>
								...
								<tr>
									...
									<td>
										<input type="password" name="user.upass">
									</td>
									<tr>
										<tr>
											<td>
											...
											<tr>
												<td>
													<input type="submit" value="注册" class="btn" onclick=pass()>
													&nbsp;
												</td>
												<td>
