...
-->
					...
					<table align="center">
						...
						<tr>
							<td width='150'>
								<a href="user_guanli?userid=<s:property value='user.uuid'/>">管理我的租房信息</a>
							</td>
						</tr>
						<tr>
							<td width='100'>
...
.table_title {
	...
	border-width: 0 0 1px 0;
				...
				<td width="495" align="center">
					<br />
					<form action="user_hightQuery" method="post" name="mf">
	...
	if (o) {
		if (o.style.display == "none") {
			...
			<tr>
				<td>房屋类型：</td>
				<td>
				<s:radio list="#{1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}"  name="fd.lxid" value="%{fd.lxid}"></s:radio>
				</td>
			</tr>
			<tr>
				<td>发布日期：</td>
				<td><select name="fd.time" style="width:80">
					...
					<option value="30">近一月</option>
						...
						<table width="88%" cellspacing="0">
							...
							<tr>
								<td>
									<a href="user_find?fwid=<s:property value='#xinxi.fwid'/>"><s:property value="#xinxi.title"/> </a>
								</td>
						...
						<fenye:kzPage max="${max}" url="user_currentPage" page="${page}"></fenye:kzPage>
					</form>
				</td>
