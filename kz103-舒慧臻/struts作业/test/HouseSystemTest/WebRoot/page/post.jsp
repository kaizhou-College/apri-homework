...
-->
				...
				<td width="495">
					...
					<form action="user_add" method="post" name="mf"
						...
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" name="xx.telephone">
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<textarea name="xx.fwxx" rows="10" cols="40"></textarea>
								</td>
							</tr>
							<tr>
								<td colspan="2">
