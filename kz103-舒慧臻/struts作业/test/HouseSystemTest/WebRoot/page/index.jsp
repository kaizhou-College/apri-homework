...
-->
					...
					<form action="user_denglu" method="post" name="myForm"
						...
						<table align="center">
							...
							<tr>
								<td colspan="2">
									<input type="text" name="user.uname" size=10 " class="editbox">
								</td>
							</tr>
							<tr>
								<td colspan="2">
							...
							<tr>
								<td colspan="2">
									<input type="password" name="user.upass" size=10 "  class='editbox'>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									<a href="${basePath}page/reg.jsp">注册用户</a>
								</td>
							</tr>
						</table>
					</form>
			...
			o.style.display = "none";
						...
						<table width="88%;" id="advSearch"
							...
							<tr>
								...
								<td>
									<input type="text" name="zj" size="5" class="unnamed1">
									至
									<input type="text" name="zj1" size="5" class="unnamed1">
									元/月
								</td>
							</tr>
							<tr>
						...
						<fenye:kzPage max="${max}" url="user_list" page="${page}"></fenye:kzPage>
					</form>
				</td>
