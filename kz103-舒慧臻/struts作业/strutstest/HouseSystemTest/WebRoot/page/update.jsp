...
-->
				...
				<td width="495">
					...
					<form action="user_update" method="post" name="mf"
						...
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" name="xx.title" value="${xx.title}">
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									<strong>街道：</strong>
									<input type="hidden" name="xx.jdid" value="${xx.jdid}"/>
									<input type="hidden" name="xx.fwid" value="${xx.fwid}"/>
								</td>
								<td>
									<select name="jdid">
										<option value="0">
							...
							<tr>
								...
								<td>
									<input type="text" name="xx.zj"  value="${xx.zj}"/>
									元/月
								</td>
							</tr>
							<tr>
								...
								<td>
									<select name="xx.shi" >
										<option value="1" <c:if test="${xx.shi==1}">selected="selected"</c:if> >
											1
										</option>
										<option value="2" <c:if test="${xx.shi==2}">selected="selected"</c:if>>
											2
										</option>
										<option value="3" <c:if test="${xx.shi==3}">selected="selected"</c:if>>
											3
										</option>
										<option value="4" <c:if test="${xx.shi==4}">selected="selected"</c:if>>
											4
										</option>
										<option value="5" <c:if test="${xx.shi==5}">selected="selected"</c:if>>
											5
										</option>
										<option value="6" <c:if test="${xx.shi==6}">selected="selected"</c:if>>
											6
										</option>
										<option value="7" <c:if test="${xx.shi==7}">selected="selected"</c:if>>
											7
										</option>
										<option value="8" <c:if test="${xx.shi==8}">selected="selected"</c:if>>
											8
										</option>
										<option value="9" <c:if test="${xx.shi==9}">selected="selected"</c:if>>
											9
										</option>
									</select>
									室
									<select name="xx.ting">
										<option value="1" <c:if test="${xx.ting==1}">selected="selected"</c:if>>
											1
										</option>
										<option value="2" <c:if test="${xx.ting==2}">selected="selected"</c:if>>
											2
										</option>
										<option value="3" <c:if test="${xx.ting==3}">selected="selected"</c:if>>
											3
										</option>
										<option value="4" <c:if test="${xx.ting==4}">selected="selected"</c:if>>
											4
										</option>
										<option value="5" <c:if test="${xx.ting==5}">selected="selected"</c:if>>
											5
										</option>
									</select>
									厅
							...
							<tr>
								...
								<td>
									<select name="xx.lxid">
										...
										<option value='1' <c:if test="${xx.lxid==1}">selected="selected"</c:if>>
											地下室
										</option>
										<option value='2' <c:if test="${xx.lxid==1}">selected="selected"</c:if>>
											平房
										</option>
										<option value='3' <c:if test="${xx.lxid==1}">selected="selected"</c:if>>
											普通住宅
										</option>
										<option value='4' <c:if test="${xx.lxid==1}">selected="selected"</c:if>>
											公寓
										</option>
										<option value='5' <c:if test="${xx.lxid==1}">selected="selected"</c:if>>
											别墅
										</option>
									</select>
								</td>
							...
							<tr>
								...
								<td>
									<input type="text" name="xx.telephone" value="${xx.telephone}">
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="xx.lxr" value="${xx.lxr}">
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea name="xx.fwxx" rows="10" cols="40">${xx.fwxx}</textarea>
								</td>
							</tr>
							<tr>
								<td colspan="2">
