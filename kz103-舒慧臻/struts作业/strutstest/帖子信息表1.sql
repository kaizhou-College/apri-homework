...
prompt Created on 2017年11月30日 by ordinary
set feedback off
set define off
...
values (5, 2, 3, 2, 1, 2, '地方吃蔬菜', 2345, '爱迪生大', to_date('15-11-2017', 'dd-mm-yyyy'), '12344134332', '拭擦');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (6, 0, 3, 5, 2, 3, '大发文', 5321, '阿发符文发啊2', to_date('08-11-2017', 'dd-mm-yyyy'), '15345135235', '大');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (25, 2, 1, 3, 4, null, '而过切过去额', 4243, '电饭煲电饭锅', to_date('07-11-2017', 'dd-mm-yyyy'), '235523442', null);
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (43, 0, 1, 0, 2, null, '服务而服务器', 222, '公司帝国时代', null, '2234234', null);
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (9, 2, 4, 1, 1, 1, '微任务瓦', 1231, '啊沙发哇查收vsad', to_date('08-11-2017', 'dd-mm-yyyy'), '46573221512', '阿飞让我去');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (1, 1, 1, 1, 3, 2, '采光好', 3000, '出租健翔桥二居室', to_date('14-11-2017', 'dd-mm-yyyy'), '15678998765', '王先生');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (2, 1, 2, 2, 1, 2, '温馨独居室', 2300, '北大附近招合租', to_date('08-11-2017', 'dd-mm-yyyy'), '17623456789', 'lady');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (22, 2, 1, 2, 3, null, '关切给我人头', 2423, '王企鹅废弃物过且过', to_date('09-11-2017', 'dd-mm-yyyy'), '242352352', null);
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (4, 1, 3, 1, 3, 1, '靠近市中心的学校哦', 3500, '西便门北二区出租3室1厅', to_date('07-11-2017', 'dd-mm-yyyy'), '18934356743', '楼女士');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (24, 0, 1, 0, 3, null, '电饭锅', 4325, '高峰期废弃物', null, '2353552523', null);
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (7, 0, 2, 0, 2, 3, '商务房', 4500, '欢迎办公环境雅致发FWEQ', to_date('17-11-2017', 'dd-mm-yyyy'), '14723344234', '小二同学');
commit;
