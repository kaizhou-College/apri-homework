...
//		update teacherinfo set teachername='ŒO™à',teachertel='13354564488',teacheremail='sq@sina.cm' where teacherid='4'
	...
	public static List<Object> load(Class cls,int id){
		List<Object> list = new ArrayList<Object>();
		StringBuffer sql = new StringBuffer();
		sql.append("select ");
		Field[] Teachers = cls.getDeclaredFields();
...
//	}
	public static void main(String[] args) throws Exception {
		...
		Constructor cls2 = cls.getConstructor(int.class,String.class,String.class,String.class);
		Object obj = cls2.newInstance(4,"„¢‚ä","15288312245","lb@sina.com");
		List<Object> load = load(cls,4);
