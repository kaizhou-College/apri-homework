...
-->
	...
	<tr>
		<td width='150'><a href="view_showAll">管理我的租房信息</a></td>
	</tr>
	<tr>
		<td width='100'><a href="manager_ss">发布租房信息</a></td>
	</tr>
	<tr>
...
border-width:0 0 1px 0;
	...
	<form action="view_Qeury" method="post" name="mf">
...
<option value='18'>平谷</option>
			...
			<tr>
				<td>户型：</td>
				<td><select name="fwxx.shi" style="width:60">
					<option value="0">不限--</option>
				...
				</select>室 <select name="fwxx.ting" style="width:60">
					<option value="0">不限--</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
