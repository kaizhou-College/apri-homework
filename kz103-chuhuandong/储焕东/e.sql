----------------------------------------------
-- Export file for user WANGDAPAO           --
-- Created by ichdx on 2017/11/29, 14:28:56 --
----------------------------------------------
...
prompt =======================
prompt
create table WANGDAPAO.TBL_FWLX
(
...
alter table WANGDAPAO.TBL_FWLX
...
prompt =======================
prompt
create table WANGDAPAO.TBL_FWXX
(
...
alter table WANGDAPAO.TBL_FWXX
...
prompt =======================
prompt
create table WANGDAPAO.TBL_USER
(
  UUID  NUMBER,
...
alter table WANGDAPAO.TBL_USER
...
prompt ======================
prompt
create sequence WANGDAPAO.FWXX
minvalue 1
...
prompt
prompt Creating sequence FWXXDID
prompt =========================
prompt
create sequence WANGDAPAO.FWXXDID
minvalue 1
maxvalue 999999999999999999999999999
start with 61
increment by 1
...
prompt
prompt Creating sequence USERIDS
prompt =========================
prompt
create sequence WANGDAPAO.USERIDS
minvalue 1
maxvalue 999999999999999999999999999
start with 21
increment by 1
...
values (3, 1, 234, 1, 3, 3, '啊实打实的撒大苏打', 50000, '王大炮的老乡', to_date('27-11-2017', 'dd-mm-yyyy'), '15615615', '撒打算');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (23, 1, 18, 1, 3, 3, 'sadasdasdasdasd', 50000, '王大炮的老乡', to_date('27-11-2017', 'dd-mm-yyyy'), '15615615', '撒打算');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (24, 3, 173, 3, 3, 1, 'asdasdasd', 1000, 'hehehe呵呵', to_date('01-11-2017', 'dd-mm-yyyy'), '13300313', 'asdsad');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (21, 1, 339, 1, 4, 3, '萨达萨达', 10000, '啊萨达萨达是', to_date('15-11-2017', 'dd-mm-yyyy'), '12354654', 'asdasadssdasd');
insert into TBL_FWXX (FWID, UUID, JDID, LXID, SHI, TING, FWXX, ZJ, TITLE, PUBLISHDATE, TELEPHONE, LXR)
values (41, 1, 120, 1, 4, 3, 'asdasdasdasd', 1000, 'dadadadad', to_date('29-11-2017', 'dd-mm-yyyy'), '13313000', 'asdsad');
commit;
prompt 5 records loaded
