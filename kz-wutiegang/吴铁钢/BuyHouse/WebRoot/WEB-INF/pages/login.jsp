...
-->
					...
					<table align="center">
						...
						<tr>
							<td width='150'>
								<a
									href="fwxx_my?user.uuid=${uuid}">管理我的租房信息</a>
							</td>
						</tr>
						<tr>
							<td width='100'>
								<a href="fwxx_post">发布租房信息</a>
							</td>
						</tr>
						<tr>
							<td width='100'>
								<a href="user_loginout">[注销]</a>
							</td>
						</tr>
					</table>
					<style>
...
.table_title {
	...
	border-width: 0 0 1px 0;
				...
				<td width="495" align="center">
					<br />
					<form action="fwxx_query" method="post" name="mf">
			...
			o.style.display = "none";
						...
						<table width="88%;" id="advSearch"
							...
							<tr>
								...
								<td>
<s:select list="#{1:'海淀',2:'朝阳',3:'崇文',4:'宣武',5:'东城',6:'西城',7:'通州',8:'丰台'}" size="width: 80" headerKey="0" headerValue="--不限--" name="queryfwxx.qxid" onchange="selectjd()"></s:select>
							...
							--%><tr>
								...
								<td>
								<s:select list="#{1:'中关村',2:'北京大学',3:'清华大学',4:'上地',5:'白颐路',6:'渔阳',7:'学院路',8:'西直门外',9:'大榆树'}" headerKey="0" headerValue="--不限--" name="queryfwxx.jdid" size="width: 80"></s:select>
							...
							<tr>
								...
								<td>
									<input type="text" name="queryfwxx.startzj" size="5" class="unnamed1">
									至
									<input type="text" name="queryfwxx.endzj" size="5" class="unnamed1">
									元/月
								</td>
							</tr>
							<tr>
								...
								<td>
								<s:select list="#{1:'一',2:'二',3:'三',4:'四',5:'五',6:'六',7:'七',8:'八',9:'九'}" size="width: 60" name="queryfwxx.shi" headerKey="0" headerValue="--不限--"></s:select>
				室
				<s:select list="#{1:'一',2:'二',3:'三',4:'四',5:'五'}" size="width: 60" name="queryfwxx.ting" headerKey="0" headerValue="--不限--"></s:select>
				厅
							...
							<tr>
								...
								<td>
								<s:radio list="#{1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}" value="" id="fwlx" name="queryfwxx.lxid"></s:radio>
							...
							<tr>
								...
								<td>
									<select name="queryfwxx.queryDate" style="width: 80">
										<option value="0">
											不限--
										</option>
										<option value="1">
						...
						<table width="88%" cellspacing="0">
							...
							<s:iterator value="fwxx" var="fwxx">
								<tr>
									<td>
										<a href='fwxx_look?tblfwxx.fwid=<s:property value="#fwxx.fwid" />'><s:property value="#fwxx.title" />
										</a>
									</td>
									<td align='center' style='height: 30px;'>
										<s:property value="#fwxx.zj" />
										元
									</td>
									<td align='center'>
										<s:property value="#fwxx.publishdate" />
									</td>
								</tr>
						...
						<kz:kzPage max="${max}" url="fwxx_query" page="${page}"></kz:kzPage>
					</form>
				</td>
