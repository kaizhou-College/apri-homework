...
-->
	...
	<form action="fwxx_confirm" method="post" name="mf" onsubmit="return validateTitle()">
		...
		<table>
			...
			<tr>
			  <td><strong>标题：</strong></td>
				<td><input type="text" name="tblfwxx.title"></td>
			</tr>
			<%--<tr>
			  <td><strong>区县：</strong></td>
				<td>
				<s:select list="#{1:'海淀',2:'朝阳',3:'崇文',4:'宣武',5:'东城',6:'西城',7:'通州',8:'丰台'}" headerKey="0" headerValue="--不限--" name="tblfwxx.qxid" onchange="selectjd()"></s:select>
			...
			--%><tr>
			  <td><strong>街道：</strong></td>
				<td>
				<s:select list="#{1:'中关村',2:'北京大学',3:'清华大学',4:'上地',5:'白颐路',6:'渔阳',7:'学院路',8:'西直门外',9:'大榆树'}" headerKey="0" headerValue="--不限--" name="tblfwxx.jdid" size="width: 80"></s:select>
				
				</td>
			</tr>
			<tr>
			  <td><strong>租金：</strong></td>
				<td><input type="text" name="tblfwxx.zj"/>元/月</td>
			</tr>
			<tr>
			  <td><strong>户型：</strong></td>
				<td>
				<s:select list="#{1:'一',2:'二',3:'三',4:'四',5:'五',6:'六',7:'七',8:'八',9:'九'}"  name="tblfwxx.shi" headerKey="0" headerValue="--不限--"></s:select>
				室
				<s:select list="#{1:'一',2:'二',3:'三',4:'四',5:'五'}" name="tblfwxx.ting" headerKey="0" headerValue="--不限--"></s:select>
				厅
				</td>
			</tr>
			<tr>
			  <td><strong>房屋类型：</strong></td>
				<td>
				<s:select list="#{1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}" headerKey="0" headerValue="--不限--" name="tblfwxx.lxid"></s:select>
			</td>
			</tr>
			<tr>
			  <td><strong>联系电话：</strong></td>
				<td><input type="text" name="tblfwxx.telephone"></td>
			</tr>
			<tr>
			  <td><strong>联系人：</strong></td>
				<td><input type="text" name="tblfwxx.lxr"></td>
			</tr>
			<tr>
			  <td><strong>房屋信息：</strong></td>
				<td><textarea name="tblfwxx.fwxx" rows="10" cols="40"></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
