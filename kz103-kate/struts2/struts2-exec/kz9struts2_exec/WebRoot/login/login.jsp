						...
						<tr>
							<td bgcolor="#FFFFFF">
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td height="74">
											<img src="${basePath}/images/logintitle.gif">
										</td>
									</tr>
									<tr>
										<td align="center" valign="bottom" background="${basePath}/images/loginbg.gif">
											<form id="loginAction_home" name="form1" action="user_login" target="_parent" method="post">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<td>
															<input type="text" name="user.logonName" value="admin" id="logonName" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
														<td height="30" nowrap>
														...
														<td>
															<input type="password" name="user.logonPwd" value="admin" id="logonPwd" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
