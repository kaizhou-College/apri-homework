...
<HTML>
	...
	<body>
		...
		<s:form id="userAction_save_do" name="Form1" action="user_save" namespace="/" method="post" enctype="multipart/form-data">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield name="logonPwd" value="" id="logonPwd"></s:textfield>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						用户姓名：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield name="userName" value="" id="userAction_save_do_userName" cssClass="bg"></s:textfield>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield type="text" name="birthday" size="20" value="" readonly="readonly" id="birthday"></s:textfield>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						电话：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield type="text" name="telephone" value="" id="telephone"></s:textfield>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<s:checkboxlist list="{'看电影','旅游','健身','购物','睡觉'}" id="interest" name="interest"></s:checkboxlist>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<s:textfield type="file" name="upload" size="30" value="" id="userAction_save_do_upload"></s:textfield>
					</td>
				</tr>
				<TR>
