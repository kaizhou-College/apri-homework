				...
				<DIV class=box>
					<FORM id=add_action method=post name=add.action
							...
							<TABLE class=field>
								<TBODY>
									...
									<TR>
										...
										<TD>
											<s:select list="types" listKey="id" listValue="name"  value="%{house.type_id}" name=""></s:select>
										</TD>
									</TR>
									<TR>
										<TD class=field>
									...
									<TR>
										...
										<TD>
											<INPUT id=add_action_price class=text type=text name=price value="${house.price}">
										</TD>
									</TR>
									<TR>
										<TD class=field>
										...
										<TD>
											<INPUT class=text type=text name=houseDate value="${house.pubdate}">
										</TD>
									</TR>
									<TR>
										<TD class=field>
										...
										<TD>
											区：
											<s:select list="dises" listKey="id" listValue="name" value="tempStreet.district_id"  name=""></s:select>
											街：
										<s:select list="streets" listKey="id" listValue="name"  value="%{house.street_id}" name=""></s:select>
										</TD>
									</TR>
									<!-- 
						<tr>
						...
						-->
									...
									<TR>
										...
										<TD>
											<INPUT id=add_action_contact class=text type=text
												name=contact value="${house.contact}">
										</TD>
									</TR>
									<TR>
										<TD class=field>
							...
							<DIV class=buttons>
								<INPUT onclick='document.location="list.htm"' value=立即修改
									type=button>
							</DIV>
						</DIV>
					</FORM>
