...
public class HouseAction {
	private static final int DEFAULT_HOUSE_PAGE_SIZE = 1;
	...
	private Street tempStreet;//房子所属的区
	public String edit() throws InstantiationException, IllegalAccessException{
		...
		//4,查询所有街道
		BaseDao<Street> strDao = new BaseDao<Street>();
		streets = strDao.find(Street.class);
