					...
					<FORM id=user method=post name=user
								...
								<TBODY>
									...
									<TR>
										...
										<TD>
											...
											<INPUT id=user_name class=text type=text name=user.name value="二狗子">
										</TD>
									</TR>
									<TR>
										<TD class=field>
										...
										<TD>
											...
											<INPUT id=user_password class=text type=password value="123"
												name=user.password>
										</TD>
									</TR>
									<!--
						...
						-->
							...
							<DIV class=buttons>
								...
								<INPUT onclick='document.location="regs.htm"' value=注册
									type=button>
							</DIV>
						</DIV>
					</FORM>
