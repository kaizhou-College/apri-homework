...
function createAjax(){
	...
	<form action="fwxx_updateListTBL" method="post" name="mf" onsubmit="return validateTitle()">
		<input type="hidden" name="tbl_fwxx.fwid" value="<s:property value='listFwxx.get(0).fwid'/>"/>
		<input type="hidden" name="tbl_fwxx.publishdate" value="<s:property value='listFwxx.get(0).publishdate'/>">
		<input type="hidden" name="tbl_fwxx.uuid" value="<s:property value='listFwxx.get(0).uuid'/>">
		<table>
			<tr>
			...
			<tr>
			  <td><strong>标题：</strong></td>
				<td><input type="text" name="tbl_fwxx.title" value="<s:property value='listFwxx.get(0).title'/>"></td>
			</tr>
			<tr>
			  <td><strong>区县：</strong></td>
				<td>
					<s:select name="qxjd.qu" id="quxian" list="qxList" key="QxIDList.get(0).qx" onchange="pickCityGet()" ></s:select>	
				</td>
			</tr>
			<tr>
			  <td><strong>街道：</strong></td>
				<td>
					<s:select name="qxjd.jieDao" list="jdList" key="jdIDList.get(0).jd" id="jdid"></s:select>
				</td>
			</tr>
			<tr>
			  <td><strong>租金：</strong></td>
				<td><input type="text" name="tbl_fwxx.zj" value="<s:property value='listFwxx.get(0).zj'/>"/>元/月</td>
			</tr>
			<tr>
			  <td><strong>户型：</strong></td>
				<td>
				<s:select list="{'1','2','3','4','5','6','7','8','9'}"  value="listFwxx.get(0).shi" name="tbl_fwxx.shi"></s:select>
				室
				<s:select list="{'1','2','3','4','5'}"  value="listFwxx.get(0).ting" name="tbl_fwxx.ting"></s:select>
				厅</td>
			</tr>
			<tr>
			  <td><strong>房屋类型：</strong></td>
				<td>
					<s:select name="tbl_fwxx.lxid" list="#{-1:'不限',1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}" value="listFwxx.get(0).lxid" ></s:select>
				</td>
			</tr>
			<tr>
			  <td><strong>联系电话：</strong></td>
				<td><input type="text" name="tbl_fwxx.telephone" value="<s:property value='listFwxx.get(0).telephone'/>"></td>
			</tr>
			<tr>
			  <td><strong>联系人：</strong></td>
				<td><input type="text" name="tbl_fwxx.lxr" value="<s:property value='listFwxx.get(0).lxr'/>"></td>
			</tr>
			<tr>
			  <td> <strong>房屋信息：</strong></td>
				<td><textarea name="tbl_fwxx.fwxx" rows="10" cols="40">
					<s:property value="listFwxx.get(0).fwxx"/> 
				</textarea></td>
			</tr>
			<tr>
				<td colspan="2">
