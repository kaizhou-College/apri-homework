...
-->
	...
	<form action="user_loginUser" method="post" name="myForm" onsubmit="return login()">
  	<p>&nbsp;</p>
	  <table align="center" >
		<tr>
			<td colspan="2">用户名：</td>
		...
		<tr>
		  <td colspan="2">
		  	<s:textfield  name="login.uname" size="10"  ></s:textfield>
		  	<s:fielderror fieldName="login.uname"></s:fielderror>
		  </td>
		</tr>
		<tr>
			<td colspan="2">密&nbsp;&nbsp;码：</td>
		...
		<tr>
		  <td colspan="2">
		  <s:textfield  type="password" name="login.upass" size="10" ></s:textfield>
		  <s:fielderror fieldName="login.upass"></s:fielderror>
		  </tr>
		<tr>
			<td>
