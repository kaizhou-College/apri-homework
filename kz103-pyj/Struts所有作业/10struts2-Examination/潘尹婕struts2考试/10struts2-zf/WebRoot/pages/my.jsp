...
-->
	...
	<table align="center">
	<tr>
		<td width=''><font color='red'>当前用户：${tbu.uname}</font>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width='100'><a href="${basePath}pages/login_from.jsp">返回首页</a></td>
	</tr>
	<tr>
		<td width='100'><a href="${basePath}index.jsp">[注销]</a></td>
	</tr>
	</table>
</td>
	...
	<table>
		<tr>
			...
			<table width='450' border='0'>
				...
				<c:forEach items="${tfwxx}" var="list">
					<tr>
						<td><a href='detail.htm'>${list.title }</a></td>
						<td align='center' style='height:30px;'>${list.zj}元</td>
						<td align='center' style='height:30px;'>${list.publishdate}</td>
						<td align='center' style='height:30px;'><a href="fwxx_del?tbfwxx.fwid=${list.fwid}">[删除]</a></td>
						<td align='center' style='height:30px;'><a href='fwxx_editJump?tbfwxx.fwid=${list.fwid}'>[修改]</a></td>
					</tr>
				</c:forEach>
				<tr>
					<td colspan='5'><hr/></td>
			...
			<pan:page pageIndex="${pageIndex}" pageSize="${pages}" pageUrl="fwxx_glList"></pan:page>
		</form>
			</td>
		</tr>
		<tr>
