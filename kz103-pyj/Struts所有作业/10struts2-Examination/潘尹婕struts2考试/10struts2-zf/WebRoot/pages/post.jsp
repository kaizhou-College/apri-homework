...
-->
	...
	<table align="center">
		...
		<td width="495">
			<form action="fwxx_add" method="post" name="mf" onsubmit="return validateTitle()">
				<input type="hidden" name="tbfwxx.uuid" value="${tbu.uuid}" />
					<table>
						...
						<tr>
							...
							<td><input type="text" name="tbfwxx.title"></td>
						</tr>
						<%--<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="tbfwxx.zj" />元/月
							</td>
						</tr>
						<tr>
							<td><strong>户型：</strong></td>
							<td>
								<select name="tbfwxx.shi"">
						...
						<tr>
							...
							<td><input type="text" name="tbfwxx.telephone"></td>
						</tr>
						<tr>
							<td><strong>联系人：</strong></td>
							<td><input type="text" name="tbfwxx.lxr"></td>
						</tr>
						<tr>
							<td><strong>房屋信息：</strong></td>
							<td><textarea name="tbfwxx.fwxx" rows="10" cols="40"></textarea></td>
						</tr>
						<tr>
							<td colspan="2">
								<div align="center">
