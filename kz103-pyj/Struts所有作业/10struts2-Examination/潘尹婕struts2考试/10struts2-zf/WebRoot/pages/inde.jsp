...
-->
	...
	<form action="user_login" method="post" name="myForm" onsubmit="return login()">
	  ...
	  <table align="center">
		...
		<tr>
		  <td colspan="2"><input type="text" name="tbu.uname" size=10" class="editbox"></td>
		</tr>
		<tr>
			<td colspan="2">密&nbsp;&nbsp;码：</td>
			</tr>
		<tr>
		  <td colspan="2"><input type="password" name="tbu.upass" size=10"  class='editbox'></td>
		  </tr>
		<tr>
			<td>
...
<table width="88%" cellspacing="0">
				...
				<tr>
					<td><a href='detail.htm'><s:property value="#tfwxx.title"/> </a></td>
					<td align='center' style='height:30px;'><s:property value="#tfwxx.zj"/> 元</td>
					<td align='center'><s:property value="#tfwxx.publishdate"/></td>
				</tr>
				</s:iterator>
				<tr>
					<td colspan='3'><hr/></td>
