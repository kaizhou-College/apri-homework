...
<link href="${basePath}${basePath}style/texts.css" rel="stylesheet" type="text/css" />
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table align="center">
		<tr>
		  <td><a href="${basePath}pages/inde.jsp">返回首页</a></td>
		</tr>
		<tr>
		  <td><a href="${basePath}pages/reg.jsp">用户注册</a></td>
		</tr>
	</table>
	</td>
	...
	<form action="user_login" method="post" name="myForm" onsubmit="return login()">
		<table align="center">
			...
			<tr>
				<td>用户名：</td>
				<td><input type="text" name="tbu.uname" ></td>
			</tr>
			<tr>
				<td>密码：</td>
				<td><input type="password" name="tbu.upass" ></td>
			</tr>
			<tr>
				<td>
