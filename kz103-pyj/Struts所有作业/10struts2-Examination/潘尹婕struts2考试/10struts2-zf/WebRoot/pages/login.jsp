...
-->
					...
					<table align="center">
						<tr>
							<td width=''><font color='red'>当前用户:${tbu.uname}</font></td>
						</tr>
						<tr>
							<td width='150'><a href="fwxx_queryById?uid=${tbu.uuid}">管理我的租房信息</a></td>
						</tr>
						<tr>
							<td width='100'><a href="${basePath}pages/post.jsp">发布租房信息</a></td>
						</tr>
						<tr>
...
function fswitch(id) {
	...
	if (o) {
		...
		<div style="text-align: left; width: 88%;">
			<input><%--
				//<input type="text" name="fs.title" value="${fs.title}"/>
		...
		<table width="88%;" id="advSearch" style="border: solid 0px #000; display: none;">
			<%--<tr>
				...
				<td>
				<select name="qxid" onChange="selectjd()" style="width: 80">
			...
			<td rowspan="6">&nbsp;</td>
				...
				<tr>
					<td>街道：</td>
					<td>
						<select name="jdid" style="width: 80">
							<option value="0">不限--</option>
						</select>
					</td>
				</tr>
				...
				<tr>
					<td>租金：</td>
						<td>
							<input type="text" name="fs.startzj" value="${fs.startzj}" size="5" class="unnamed1">至
							<input type="text" name="fs.endzj" value="${fs.endzj}" size="5" class="unnamed1">元/月
						</td>
				</tr>
				<tr>
					<td>户型：</td>
						<td>
							<select name="fs.shi" style="width: 60">
								<option value="0">不限--</option>
							...
							室
							<select name="fs.ting" style="width: 60">
								<option value="0">不限--</option>
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
				...
				<tr>
					<td>房屋类型：</td>
						<td>
							<s:radio list="#{1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}" name="fs.lxid" value="%{fs.lxid}"></s:radio>
						</td>
				</tr>
				<tr>
					<td>发布日期：</td>
						<td>
							<select name="fs.time" style="width: 80">
								<option value="0">不限--</option>
		...
		<table width="88%" cellspacing="0">
				...
				<s:iterator value="tfwxx" var="tfwxx">
					<tr>
						<td>
							<a href='detail.htm'><s:property value="#tfwxx.title" /></a>
						</td>
						<td align='center' style='height: 30px;'>
							<s:property value="#tfwxx.zj" />元
						</td>
						<td align='center'>
							<s:property value="#tfwxx.publishdate" />
						</td>
					</tr>
				</s:iterator>
			<tr>
			...
			<pan:page pageIndex="${pageIndex}" pageSize="${pages}" pageUrl="fwxx_list"></pan:page>
</form>
			</td>
