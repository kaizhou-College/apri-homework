...
-->
	...
	<table align="center">
		...
		<tr>
			<td width='100'>
				<a href="${basePath}pages/post.jsp">发布租房信息</a>
			</td>
		</tr>
		<tr>
			<td width='100'>
		...
		<td width="495">
			<form action="fwxx_edit" method="post" name="mf" onsubmit="return validateTitle()">
			<input type="hidden" name="tbfwxx.fwid" value="${tbfwxx.fwid}"/>
			<input type="hidden" name="tbfwxx.uuid" value="${tbu.uuid}"/><%--
			<input type="hidden" name="tbfwxx.lxid" value="${tbfwxx.lxid}"/>
			<input type="hidden" name="tbfwxx.shi" value="${tbfwxx.shi}"/>
			<input type="hidden" name="tbfwxx.ting" value="${tbfwxx.ting}"/>
			<input type="hidden" name="tbfwxx.fwxx" value="${tbfwxx.fwxx}"/>
			<input type="hidden" name="tbfwxx.zj" value="${tbfwxx.zj}"/>
			<input type="hidden" name="tbfwxx.title" value="${tbfwxx.title}"/>
			<input type="hidden" name="tbfwxx.publishdate" value="${tbfwxx.publishdate}"/>
			<input type="hidden" name="tbfwxx.telephone" value="${tbfwxx.telephone}"/>
			<input type="hidden" name="tbfwxx.lxr" value="${tbfwxx.lxr}"/>
					--%><table>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="tbfwxx.title" value="${tbfwxx.title}"></td>
						</tr>
						<%--<tr>
							<td><strong>区县：</strong></td>
							<td>
								<select name="qxid" onChange="selectjd()">
						...
						<tr>
							...
							<td>
								<select name="tbfwxx.jdid" value="${tbfwxx.jdid}">
									<option value="0">不限--</option>
								</select>
							</td>
						</tr>--%>
						<tr>
							...
							<td>
								<input type="text" name="tbfwxx.zj" value="${tbfwxx.zj}"/>元/月
							</td>
						</tr>
						<tr>
							<td><strong>户型：</strong></td>
							<td>
								<s:select name="tbfwxx.shi"  list="{'1','2','3','4','5','6','7','8','9'}" value="%{tbfwxx.shi}"></s:select>室
								<s:select name="tbfwxx.ting" list="{'1','2','3','4','5'}" value="%{tbfwxx.ting}"></s:select>厅
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<s:select name="tbfwxx.lxid" list="#{1:'地下室',2:'平房',3:'普通住宅',4:'公寓',5:'别墅'}" value="%{tbfwxx.lxid}"></s:select>
							</td>
						</tr>
						<tr>
							<td><strong>联系电话：</strong></td>
							<td><input type="text" name="tbfwxx.telephone" value="${tbfwxx.telephone}"></td>
						</tr>
						<tr>
							<td><strong>联系人：</strong></td>
							<td><input type="text" name="tbfwxx.lxr" value="${tbfwxx.lxr}"></td>
						</tr>
						<tr>
							<td><strong>房屋信息：</strong></td>
							<td><textarea name="tbfwxx.fwxx" value="${tbfwxx.fwxx}" rows="10" cols="40"></textarea></td>
						</tr>
						<tr>
							<td colspan="2">
								<div align="center">
